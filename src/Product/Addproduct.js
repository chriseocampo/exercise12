    ...
    axios
      ...
      .then((json) => {
        if (json.data.Status === "Success") {
          ...
          alert("Product cannot be added. One or more inputs has an invalid input type.");
          debugger;
        }
      });
  };
  ...
  render() {
    ...
    return (
      <Container className="App">
        <h5 className="PageHeading">Enter Product Details</h5>
        <br />
        <Form className="form">
          <Col>
            <FormGroup row>
            ...
            <FormGroup row>
              ...
              <Col sm={10}>
                <Input
                  ...
                  placeholder="Enter a 10 digit whole number value for the Product ID."
                />
